			...
			<div className='container-xl lg:container m-auto'>
				<div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg'>
					<InfoBox
						...
						buttonInfo={{ text: 'Parcourez les Propriétés', link: '/properties', backgroundColor: 'bg-black', textColor: 'text-white' }}
					>
					...
					<InfoBox
						...
						buttonInfo={{ text: 'Ajouter une Propriété', link: '/properties/add', backgroundColor: 'bg-blue-500', textColor: 'text-white' }}
					>
